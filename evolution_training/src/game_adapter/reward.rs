...
pub fn reward_simple_per_game(
    game: &Game,
    player_index: usize,
    number_of_moves_played: usize,
    settings: &Settings,
) -> f64 {
    ...
    if won {
        ...
        reward += settings.per_saved_turn_reward
            * (settings.max_moves_per_player - number_of_moves_played) as f64;
    }
...
pub fn reward_symmetric_per_game(
    game: &Game,
    player_index: usize,
    number_of_moves_played: usize,
    settings: &Settings,
...
mod tests {
    ...
    fn create_test_game() -> Game {
        Game {
            pawns: [Pawn::new(9, Side::Bottom, 10), Pawn::new(9, Side::Top, 10)],
            current_pawn: 0,
            board_size: 9,
            walls: Vec::new(),
        }
